...
export const LiveDashboardViewer: React.FC<LiveDashboardViewerProps> = ({
  ...
  const [activeTemplateId, setActiveTemplateId] = useState<string>(
    initialTemplateId === 'complete-bundle'
      ? 'sales-dashboard'
      : initialTemplateId
  );

  const [activeTab, setActiveTab] = useState<
    'visuals' | 'dax' | 'model' | 'theme'
  >('visuals');
  ...
  const handleExportMockData = () => {
    ...
    setTimeout(() => {
      ...
      const csvContent =
        ...
        'Date,Entity,Metric,Actual,Target,VariancePct\n' +
      ...
      link.setAttribute(
        'download',
        `${currentTemplate.slug}_SampleData.csv`
      );
  ...
  const handleTemplateChange = (templateId: string) => {
    ...
    /*
     * Always return to the dashboard canvas when switching templates.
     */
      ...
      <div className="bg-slate-900 border-b border-slate-800 px-4 py-2.5 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 hidden sm:block">
                Power BI Interactive Service Live Preview
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>
              Download .PBIX — ${currentTemplate.price} USD
            </span>
          </button>
        </div>
      </div>
      ...
      <div className="bg-slate-900/90 border-b border-slate-800 px-4 py-2 flex flex-wrap items-center justify-between gap-3 text-xs">
        ...
        <div className="flex items-center gap-1.5">
          ...
          >
            ...
            DAX Measures ({currentTemplate.daxCount})
          </button>
          ...
          >
            ...
            Star Schema ({currentTemplate.tablesCount})
          </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-white">
                Like what you see? Get this production-ready
              ...
              <p className="text-[11px] text-slate-400">
                Includes .PBIX file, Excel data model,{' '}
                {currentTemplate.daxCount} DAX formulas,
                and step-by-step PDF manual.
              </p>
            </div>
          </div>
